...
*/
	...
	class HTMLtoPDF extends tFPDF {
		...
		function OpenTag($tag, $attr) {
			...
			$line_height_adjust = 0.7;
			$font_height_adjust = 0.9;
			...
			switch($tag) {
				...
				case 'FONT':
			        ...
			        case 'P':
					$this->SetFont($this->base_font, '', 14 * $font_height_adjust);
					$this->line_height = 8 * $line_height_adjust;
			        	break;
			        ...
			        case 'H1':
					$this->SetFont($this->bold_font, '', 40 * $font_height_adjust);
					$this->line_height = 20 * $line_height_adjust;
			        	break;
			        
			        case 'H2':
					$this->SetFont($this->base_font, '', 30 * $font_height_adjust);
					$this->line_height = 15 * $line_height_adjust;
			        	break;
			        
			        case 'H3':
					$this->SetFont($this->base_font, '', 25 * $font_height_adjust);
					$this->line_height = 12 * $line_height_adjust;
			        	break;
			        
			        case 'H4':
					$this->SetFont($this->base_font, '', 20 * $font_height_adjust);
					$this->line_height = 10 * $line_height_adjust;
			        	break;
			        
			        case 'H5':
					$this->SetFont($this->base_font, '', 18 * $font_height_adjust);
					$this->line_height = 9 * $line_height_adjust;
			        	break;
			        
			        case 'H6':
					$this->SetFont($this->base_font, '', 16 * $font_height_adjust);
					$this->line_height = 8 * $line_height_adjust;
			        	break;
			}
		}
