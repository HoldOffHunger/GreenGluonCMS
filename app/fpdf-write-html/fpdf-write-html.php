...
function WriteHTML($html, $line_height)
{
    //HTML parser
    ...
    foreach($a as $i=>$e)
    {
        if($i%2==0)
        {
            //Text
            if($this->HREF)
                $this->PutLink($line_height,$this->HREF,$e);
            else
                $this->Write($line_height,stripslashes(txtentities($e)));
        }
        else
        {
            //Tag
