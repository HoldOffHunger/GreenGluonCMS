<?php
	...
	$header_secondary_args = [
		'title'=>'Total Items : ' . $this->children_count ,
	...
	print('Browse the Complete Selection of ' . $this->children_count . ' Items');
	print('</span>');
	print('</a>');
	print('</h3>');
	print('</div>');
	...
	if(count($this->images_random))
	{
		...
		print('<h2 class="horizontal-left margin-5px font-family-arial font-size-250percent">');
		print('<strong>');
		print('I Never Forget a Picture');
		print('</strong>');
		print('</h2>');
		print('</div>');
		print('</div>');
	...
	if(count($this->descriptions_random))
	{
		...
		print('<h2 class="horizontal-left margin-5px font-family-arial font-size-250percent">');
		print('<strong>');
		print('Let Me Tell You About Something');
		print('</strong>');
		print('</h2>');
		print('</div>');
		print('</div>');
	...
	if(count($this->eventdates_random))
	{
		print('<center>');
		print('<div class="horizontal-center width-95percent">');
		print('<div class="border-2px background-color-gray15 margin-5px float-left">');
		...
		foreach($this->eventdates_random as $eventdate)
		{
			...
			if(!$display_title)
			{
	    		...
	    		if (strpos($vowels, strtolower(substr($display_title, 0, 1))) !== false)
	    		{
	    			print('an ');
	    		}
	    		else
	...
	$social_media_share_links_args = [
		...
		'socialmediasharelinkargs'=>[
			url=>$this->domain_object->GetPrimaryDomain([insecure=>1, lowercase=>1, www=>1]) . '/people.php?action=index',
			title=>$this->header_title_text,
