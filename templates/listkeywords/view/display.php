<?php
	...
	$element_text_args = array(
		text=>'<span class="font-family-arial" title="' . $ignore_common_option_description_content . '">' . $ignore_common_option_content . '</span>',
		indentlevel=>5,
	);
	...
	$element_text_args = array(
		text=>'<span class="font-family-arial" title="' . $include_phrases_option_description_content . '">' . $include_phrases_option_content . '</span>',
		indentlevel=>5,
	);
	...
	$element_text_args = array(
		text=>'<span class="font-family-arial" title="' . $show_counts_option_description_content . '">' . $show_counts_option_content . '</span>',
		indentlevel=>5,
	);
