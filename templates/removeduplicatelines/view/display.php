<?php
	...
	if($this->language_object->getLanguageCode() == 'en')
	{
		$list_one_main_header_text = 'List to Remove Duplicates From';
	}
	else
	{
	...
	if($this->language_object->getLanguageCode() == 'en')
	{
		$list_two_main_header_text = 'List with Duplicates Handled';
	}
	else
	{
	...
	if($this->language_object->getLanguageCode() == 'en')
	{
		$list_two_content_text = 'Then your list with duplicates removed will appear in this text box.';
	}
	else
	{
	...
	if($this->language_object->getLanguageCode() == 'en')
	{
		$main_button_language_text = 'Remove Duplicates';
	}
	else
	{
	...
	$form->DisplayFormField($type_args);
				...
				// Get 'Sort' Order Language
				// -------------------------------------------------------
	
	if($this->language_object->getLanguageCode() == 'en')
	{
		$remove_duplicates_option_language_text_content = 'Remove Duplicates';
	}
	else
	{
		$remove_duplicates_option_language_text = $this->getListAndItems(['ListTitle'=>'LanguagesMainFirstFeatureOptionOneTitle']);
		
		if($remove_duplicates_option_language_text[$this->language_object->getLanguageCode()])
		{
			$remove_duplicates_option_language_text_content = $remove_duplicates_option_language_text[$this->language_object->getLanguageCode()];
		}
		else
		{
			$remove_duplicates_option_language_text_content = 'Remove Duplicates';
	...
	if($this->language_object->getLanguageCode() == 'en')
	{
		$remove_duplicates_description_language_text_content = 'Remove Duplicates from the First List and Place them into the Second List';
	}
	else
	{
		$remove_duplicates_description_language_text = $this->getListAndItems(['ListTitle'=>'LanguagesMainFirstFeatureOptionOneMouseover']);
		
		if($remove_duplicates_description_language_text[$this->language_object->getLanguageCode()])
		{
			$remove_duplicates_description_language_text_content = $remove_duplicates_description_language_text[$this->language_object->getLanguageCode()];
		}
		else
		{
			$remove_duplicates_description_language_text_content = 'Remove Duplicates from the First List and Place them into the Second List';
	...
	if($this->language_object->getLanguageCode() == 'en')
	{
		$find_duplicates_option_language_text_content = 'Find Duplicates';
	}
	else
	{
		$find_duplicates_option_language_text = $this->getListAndItems(['ListTitle'=>'LanguagesMainFirstFeatureOptionTwoTitle']);
		
		if($find_duplicates_option_language_text[$this->language_object->getLanguageCode()])
		{
			$find_duplicates_option_language_text_content = $find_duplicates_option_language_text[$this->language_object->getLanguageCode()];
		}
		else
		{
			$find_duplicates_option_language_text_content = 'Find Duplicates';
	...
	if($this->language_object->getLanguageCode() == 'en')
	{
		$find_duplicates_description_language_text_content = 'Find Duplicates from the First List and Place them into the Second List';
	}
	else
	{
		$find_duplicates_description_language_text = $this->getListAndItems(['ListTitle'=>'LanguagesMainFirstFeatureOptionTwoMouseover']);
		
		if($find_duplicates_description_language_text[$this->language_object->getLanguageCode()])
		{
			$find_duplicates_description_language_text_content = $find_duplicates_description_language_text[$this->language_object->getLanguageCode()];
		}
		else
		{
			$find_duplicates_description_language_text_content = 'Find Duplicates from the First List and Place them into the Second List';
	...
	$extension_args = [
		...
		options=>[
			[
				'optionvalue'=>'remove-duplicates',
				'optiontitle'=>$remove_duplicates_option_language_text_content,
				'optionmouseover'=>$find_duplicates_description_language_text_content,
			],
			[
				'optionvalue'=>'find-duplicates',
				'optiontitle'=>$find_duplicates_option_language_text_content,
				'optionmouseover'=>$find_duplicates_description_language_text_content,
			],
		],
		indentlevel=>5,
