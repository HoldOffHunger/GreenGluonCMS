<?php
	...
	#	print_r($this->parent['image']);
		...
		if($this->children && $children_count && !$quiz_mode)
		{
			...
			#	$child_title .= '</a>';
				...
				if($child_tags_count)
				{
					$first_child_tag = $child_tags[0];
					print('<input type="hidden" id="listen-to-phrase-english-' . $child['id'] . '-word-extra" value="' . $first_child_tag['Tag'] . '">');
				}
				...
				print('<div id="header_backgroundimageurl" class="border-2px background-color-gray15 margin-5px float-left">');
				print('<div class="span-header-3"><h3 style="margin:5px;padding:5px;display: inline-block;border:black 2px solid;background-color:#FFFFFF;" class="header-3 padding-0px margin-5px horizontal-left font-family-tahoma font-size-150percent"><span><a href="' . $child['Code'] . '/view.php" title="Learn More!">' . $child['Title'] . ' in ' . $this->parent['Title'] . '</a></span></h3></div>');
				print('</div>');
		...
		if($this->children && $children_count)
		{
			...
			{	
				...
				print('Take a Quiz for this Lesson Now!');
				print('</a>');
				print('</span>');
				...
				if($younger_sibling_count > 1)
				{
							// Display This+Previous Quizzes Link
					...
					print('<div class="horizontal-left margin-5px">');
					print('<span class="font-family-arial font-size-125percent">');
					print('<a href="view.php?quizmode=1&previousquizzes=1">');
					print('Take a Quiz for this Lesson and the Last Lesson Now!');
					print('</a>');
					print('</span>');
					...
					print('<strong>Words Covered :</strong> ');
					print('<em>');
					print(implode(', ', $last_previous_quiz_words));
					print('.');
					print('</em>');
					print('</span>');
				...
				if($younger_sibling_count > 2)
				{
					...
					print('<div class="horizontal-left margin-5px">');
					print('<span class="font-family-arial font-size-125percent">');
					print('<a href="view.php?quizmode=1&previousquizzes=2">');
					print('Take a Quiz for this Lesson and the Past 2 Lessons Now!');
					print('</a>');
					print('</span>');
					
					print('<div class="border-2px background-color-gray15 margin-5px float-right font-family-tahoma font-size-150percent">');
					print('<div class="margin-5px">');
					print(((2*4) + 4) . ' Questions');
					print('</div>');
					print('</div>');
					...
					print('<strong>Words Covered :</strong> ');
					print('<em>');
					print(implode(', ', $last_two_previous_quiz_words));
					print('.');
					print('</em>');
					print('</span>');
				...
				if($younger_sibling_count > 3)
				{
					...
					print('<div class="horizontal-left margin-5px">');
					print('<span class="font-family-arial font-size-125percent">');
					print('<a href="view.php?quizmode=1&previousquizzes=3">');
					print('Take a Quiz for this Lesson and the Past 3 Lessons Now!');
					print('</a>');
					print('</span>');
					
					print('<div class="border-2px background-color-gray15 margin-5px float-right font-family-tahoma font-size-150percent">');
					print('<div class="margin-5px">');
					print(((3*4) + 4) . ' Questions');
					print('</div>');
					print('</div>');
				...
				if($younger_sibling_count > 4)
				{
					...
					print('<div class="horizontal-left margin-5px">');
					print('<span class="font-family-arial font-size-125percent">');
					print('<a href="view.php?quizmode=1&previousquizzes=4">');
					print('Take a Quiz for this Lesson and the Past 4 Lessons Now!');
					print('</a>');
					print('</span>');
					
					print('<div class="border-2px background-color-gray15 margin-5px float-right font-family-tahoma font-size-150percent">');
					print('<div class="margin-5px">');
					print(((4*4) + 4) . ' Questions');
					print('</div>');
					print('</div>');
				...
				if($younger_sibling_count > 5)
				{
					...
					print('<div class="horizontal-left margin-5px">');
					print('<span class="font-family-arial font-size-125percent">');
					print('<a href="view.php?quizmode=1&previousquizzes=5">');
					print('Take a Quiz for this Lesson and the Past 5 Lessons Now!');
					print('</a>');
					print('</span>');
					
					print('<div class="border-2px background-color-gray15 margin-5px float-right font-family-tahoma font-size-150percent">');
					print('<div class="margin-5px">');
					print(((5*4) + 4) . ' Questions');
					print('</div>');
					print('</div>');
				...
				if($younger_sibling_count)
				{
					...
					print('<div class="horizontal-left margin-5px">');
					print('<span class="font-family-arial font-size-125percent">');
					print('<a href="view.php?quizmode=1&previousquizzes=10">');
					print('Take a Quiz for this Lesson and the Past ' . $younger_sibling_count . ' Lessons Now!');
					print('</a>');
					print('</span>');
					
					print('<div class="border-2px background-color-gray15 margin-5px float-right font-family-tahoma font-size-150percent">');
					print('<div class="margin-5px">');
					print((($younger_sibling_count * 4) + 4) . ' Questions');
					print('</div>');
					print('</div>');
					...
					print('<strong>Words Covered :</strong> ');
					print('<em>');
					print(implode(', ', $previous_quiz_words));
					print('.');
					print('</em>');
					print('</span>');
				...
				if($older_sibling_count)
				{
					...
					if($younger_sibling_count)
					{
						print(', the Past ' . $younger_sibling_count . ' Lessons,');
					}
					
					print(' and the Next ' . $older_sibling_count . ' Lessons Now!');
					print('</a>');
					print('</span>');
					
					print('<div class="border-2px background-color-gray15 margin-5px float-right">');
					print('<div class="margin-5px">');
					print('<span class="font-family-tahoma font-size-150percent">');
					print((($younger_sibling_count * 4) + ($older_sibling_count * 4) + 4) . ' Questions');
					print('</span>');
					print('</div>');
					print('</div>');
					
					if($previous_quiz_words && count($previous_quiz_words))
					{
						$future_quiz_words = $previous_quiz_words;
					}
					else
					{
						$future_quiz_words = $this_quiz_words;
					}
					...
					print('<strong>Words Covered :</strong> ');
					print('<em>');
					print(implode(', ', $future_quiz_words));
					print('.');
					print('</em>');
					print('</span>');
			...
			else
			{
				...
				if($new_children_count > 10)
				{
					...
					{
						$child_sorted_array[$child['entrytranslation'][0]['Title']] = $child;
					}
					
					uksort($child_sorted_array, "strnatcasecmp");
					
					$new_children = $child_sorted_array;
				} else {
					shuffle($new_children);
				}
				...
				print('<div id="header_backgroundimageurl" class="border-2px background-color-gray15 margin-5px float-left">');
				print('<span class="font-family-arial font-size-150percent margin-10px">');
				print('Listen :');
				print('</span>');
				print('</div>');
				...
				foreach($new_children as $child)
				{
					...
					print('<input type="hidden" id="listen-to-phrase-nonenglish-' . $child['id'] . '-word" value="' . $child['entrytranslation'][0]['Title'] . '">');
					print('<input type="hidden" id="listen-to-phrase-nonenglish-' . $child['id'] . '-english-translation" value="' . $child['Title'] . '">');
					print('</div>');
				...
				foreach($new_children as $child)
				{
					...
					print('<div id="header_backgroundimageurl" class="border-2px background-color-gray15 margin-5px" style="display: inline-block;">');
					print('<button id="choose-phrase-nonenglish-' . $child['id'] . '" class="font-family-arial font-size-150percent listen-to-phrase choose-answer" disabled="true">' . $child['entrytranslation'][0]['Title'] . '</button>');
					print('</div>');
					
					print('<input type="hidden" id="choose-phrase-nonenglish-' . $child['id'] . '-word" value="' . $child['entrytranslation'][0]['Title'] . '">');
				...
				foreach($new_children as $child)
				{
					...
					print('<input type="hidden" class="quiz-question" id="quiz-question-' . $child['id'] . '" name="quiz-question-' . $child['id'] . '" value="' . $child['Title'] . '">');
					$child_tags = $child['tag'];
					$child_tags_count = count($child_tags);
					...
					{
						$first_child_tag = $child_tags[0];
						print('<input type="hidden" id="quiz-question-extra-' . $child['id'] . '" value="' . $first_child_tag['Tag'] . '">');
					}
				}
				...
				print('<center id="answer-results-container" style="display:none;">');
				print('<div id="message-container" class="border-2px background-color-gray15 margin-10px" style="display: inline-block;">');
				print('<div class="margin-10px" style="display: inline-block;">');
				
				print('<span id="error-message" class="font-family-arial font-size-150percent">');
				print('Select the Answers When You are Ready');
				print('</span>');
				
				print(' ');
				
				print('<div class="border-2px background-color-gray15 margin-10px" style="display: inline-block;">');
				print('<div class="margin-10px" style="display: inline-block;">');
				print('<span class="font-family-arial font-size-150percent">');
				print('<span id="current-question-number">');
				print('</span>');
				print(' / ');
				print('<span id="total-question-count">');
				print('</span>');
				print('</span>');
				print('</div>');
				print('</div>');
				...
				print('<center class="margin-10px">');
				print('<button id="start-quiz" class="border-2px font-family-arial font-size-200percent">Start the Quiz</button>');
				print('</center>');
				
						// Display Google Search Stuff
	...
	#	print("BT: INDEX view.php script, display.php template, CHILDOF-people<BR><BR>");
		...
		*/
		...
		print('<input type="hidden" id="language" value="' . $this->object_parent . '">');
	}
?>