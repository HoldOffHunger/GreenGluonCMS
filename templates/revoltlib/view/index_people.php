<?php
	...
	$header_secondary_args = [
		'title'=>'Total People : ' . $this->children_count ,
	...
	print('Browse the Complete Selection of ' . $this->children_count . ' People');
	print('</span>');
	print('</a>');
	print('</h3>');
	print('</div>');
	...
	print('<h2 class="horizontal-left margin-5px font-family-arial font-size-250percent">');
	print('<strong>');
	print('Let Me Tell You About a Friend of Mine');
	print('</strong>');
	print('</h2>');
	print('</div>');
	print('</div>');
