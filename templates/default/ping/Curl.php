<?php
	...
	$header_primary_args = array(
		'indentlevel'=>1,
		'title'=>$this->domain_object->primary_domain . ' Ping : Curl',
	...
	$version_list_display_args = [
		...
		'list'=>[[
			'Below are the results of your Curl request.'
		]],
	];
	...
	$version_list_display_args = [
		...
		'list'=>[[
			'<nobr>Curl Request Backup :</nobr>', $this->backup_url,
		]],
	];
	$generic_list->Display($version_list_display_args);
	...
	$version_list_display_args = [
		'options'=>[
			'indentlevel'=>1,
			'tableheaders'=>0,
			'tableclass'=>'width-80percent horizontal-center border-2px background-color-gray13 margin-top-14px',
			'rowclass'=>'border-1px horizontal-left',
			'cellclass'=>[
				'border-1px vertical-top',
				'border-1px width-100percent vertical-top',
	...
	$version_list_display_args = [
		'options'=>[
			'indentlevel'=>1,
			'tableheaders'=>0,
			'tableclass'=>'width-95percent horizontal-center border-2px background-color-gray13 margin-top-14px',
			'rowclass'=>'border-1px horizontal-left',
			'cellclass'=>[
				'border-1px width-100percent vertical-top',
			],
		...
		'list'=>[[
			'<pre class="word-wrap">' . $this->EscapeHTML($this->output) . '</pre>',
		]],
	];
	$generic_list->Display($version_list_display_args);
