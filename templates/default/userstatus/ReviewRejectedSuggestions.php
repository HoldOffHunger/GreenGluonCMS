<?php
	...
	$header_primary_args = array(
		'indentlevel'=>1,
		'title'=>$this->domain_object->primary_domain . ' System Page : Review Rejected Suggestions',
	...
	foreach($this->suggestions as $suggestion)
	{
		...
		print('<input type="radio" name="accept_reject_suggestion_' . $suggestion['id'] . '" value="Accept">');
		print('Accept');
		print('<br>');
		print('<input type="radio" name="accept_reject_suggestion_' . $suggestion['id'] . '" value="Reject" CHECKED>');
		print('Reject');
		print('<br>');
