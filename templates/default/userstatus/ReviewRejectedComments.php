<?php
	...
	$header_primary_args = array(
		'indentlevel'=>1,
		'title'=>$this->domain_object->primary_domain . ' System Page : Review Rejected Comments',
	...
	foreach($this->comments as $comment)
	{
		...
		print('Accept');
		print('<br>');
		print('<input type="radio" name="accept_reject_comment_' . $comment['id'] . '" value="Reject" CHECKED>');
		print('Reject');
		print('<br>');
