<?php
	...
	$header_primary_args = [
		'indentlevel'=>1,
		'title'=>$this->domain_object->primary_domain . ' System Status : Detect Entry Code Length',
	...
	$version_list_display_args = [
		...
		'list'=>[[
			'Note: Detected a total of ' . number_format($this->broken_records_count) . ' entry code length errors.',
		]],
	];
