<?php
	...
	$header_primary_args = [
		'indentlevel'=>1,
		'title'=>$this->domain_object->primary_domain . ' System Status : Copy/Paste-Issue URL Detect',
	...
	if($results_count)
	{
		...
		$version_list_display_args = [
			...
			'list'=>[[
				'Note: Examined a total number of ' . number_format($this->entry_code_count) . ' entry records.  A total of ' . number_format(count($this->StatusDataArray)) . ' copy/paste-issue records were discovered.',
			]],
		];
