<?php
	...
	$header_primary_args = array(
		'indentlevel'=>1,
		'title'=>$this->domain_object->primary_domain . ' System Status : Binary::IncrementBinaryValue',
	...
	$table_start_args = array(
		id=>'increment-binary-value-table',
	...
	$hidden_action_args = array(
		name=>'action',
		value=>'BinaryIncrementBinaryValue',
		type=>'hidden',
		indentlevel=>1,
	);
