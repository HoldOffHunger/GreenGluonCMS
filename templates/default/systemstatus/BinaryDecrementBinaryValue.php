<?php
	...
	$header_primary_args = array(
		'indentlevel'=>1,
		'title'=>$this->domain_object->primary_domain . ' System Status : Binary::DecrementBinaryValue',
	...
	$table_start_args = array(
		id=>'decrement-binary-value-table',
	...
	$hidden_action_args = array(
		name=>'action',
		value=>'BinaryDecrementBinaryValue',
		type=>'hidden',
		indentlevel=>1,
	);
