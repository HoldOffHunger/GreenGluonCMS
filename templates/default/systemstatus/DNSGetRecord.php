<?php
	...
	$header_primary_args = array(
		'indentlevel'=>1,
		'title'=>$this->domain_object->primary_domain . ' System Status : DNS Get Record',
	...
	if(isset($this->SubmittedValue))
	{
		...
		foreach($this->StatusDataArray as $table_data)
		{
			$divider->displaystart($divider_padding_start_args);
