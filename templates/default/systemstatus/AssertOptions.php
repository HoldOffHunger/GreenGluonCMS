<?php
	...
	$username_text_args = array(
		text=>'ASSERT_ACTIVE (assert.active)',
		indentlevel=>5,
	);
	...
	$username_text_args = array(
		text=>'ASSERT_WARNING (assert.warning)',
		indentlevel=>5,
	);
	$text->Display($username_text_args);
	...
	$username_text_args = array(
		text=>'ASSERT_QUIET_EVAL (assert.quiet_eval)',
		indentlevel=>5,
	);
	$text->Display($username_text_args);
	...
	$username_text_args = array(
		text=>'ASSERT_CALLBACK (assert.callback)',
		indentlevel=>5,
	);
	$text->Display($username_text_args);
